...
CMD ["/go/src/github.com/ethereum/go-ethereum/build/bin/geth","--networkid", "1234", "--datadir", "/root/.ethereum", "--http", "--http.addr", "0.0.0.0", "--http.port", "8545", "--http.corsdomain", "*", "--http.api", "web3,eth,net,personal,miner,admin", "--http.vhosts", "*"]